...
* **Updates:** Hybrid schedules are maintained directly by the employees. Any schedule changes (swaps) trigger instant, real-time updates across the app via live gRPC streams without requiring manual page refreshes.
